...
import StyledPegaUidBooleanWrapper from './styles';

// Duplicated runtime code from Constellation Design System Component

// props passed in combination of props from property panel (config.json) and run time props from Constellation
// any default values in config.pros should be set in defaultProps at bottom of this file
const PegaUidBoolean = props => {
  const {
    getPConnect,
    value,
    label,
  ...
  if (displayMode) {
    displayComponent = <PegaUidBoolean  value={value} trueLabel={trueLabel} falseLabel={falseLabel} />;
  }

  if (displayMode === 'DISPLAY_ONLY') {
    return ( <StyledPegaUidBooleanWrapper> displayComponent </StyledPegaUidBooleanWrapper>);
  }
